...
- **Status:** 📝 **Draft — design for discussion**, with **P5-M0 cuts 1 + 2 ✅ BUILT AND USER-VERIFIED E2E 2026-07-26** (chat persistence · continuity bias). **Cut 3 (query condensation) is DROPPED for now** — see P5-M0 below. Modules P5-M1…M4 remain draft.
