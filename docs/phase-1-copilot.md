...
| **P1-M11** | **Capture reliability** | no recording the user made is silently lost (nav/upload/audio) | 🔄 **core** (R1/R2/R3) + **R6, Pause/Resume, R1 cross-origin re-arm (2026-07-01), R9 multi-tab Option A & R8 iframe (2026-07-02), R4 SW-eviction resilience, R7 on-page control bar & R10 scroll/hover/keyboard (2026-07-03) shipped**; R12/R13 → §8 backlog; R5 deferred (build TBD) |
