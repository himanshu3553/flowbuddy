...
> **What this is.** The authoritative map of the product — **Versions → Phases → Modules** — with the **status of every module** and the legacy-ID mapping so none of the work is lost. **Version 1 ships the copilot first.** For *why* copilot-first see [`product.md`](product/product.md) §5; for the *technical* model see [`architecture.md`](product/architecture.md); for build detail see [`phase-1-copilot.md`](build/phase-1-copilot.md) (Phase 1), [`phase-2-sense.md`](build/phase-2-sense.md) (Phase 2), [`agent.md`](build/agent.md) (Phase 4); the V2 portal track: [`v2-portal.md`](build/v2-portal.md). KB step-quality work (raw events → clean per-workflow steps) is **built & verified end-to-end** — see [`kb-step-distillation.md`](build/kb-step-distillation.md).
...
- **Help Portal & Articles (the portal track)** — the human-facing by-products, **moved out of Version 1 on 2026-07-08** (previously Phase 2): render approved workflows as articles + per-audience approval + presentation overlay + a public portal + productization. Full feature list: [`v2-portal.md`](build/v2-portal.md).
