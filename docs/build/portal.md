...
> **Not in this track:** the in-app **Copilot** (Phase 1), **Sense / in-context help** (Phase 2), **self-validation/drift** (Phase 3), **Autopilot / agentic execution** (Phase 4, [`agent.md`](agent.md)), the **V2 capture modalities** (narration-only + video — a separate V2 track), billing, and i18n (tracked, English-first beta).
