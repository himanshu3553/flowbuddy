...
- **Companion docs:** the map → [`roadmap.md`](../roadmap.md) §7 · the vendor-side hands (execution semantics + safety rails to mirror) → [`agent.md`](agent.md) · replay core + certification → [`roadmap.md`](../roadmap.md) §4 · the knowledge interchange this agent consumes → [`phase-6-interop.md`](phase-6-interop.md) · the surface to match and the philosophy to beat → [`competitive-claude-chrome.md`](../product/competitive-claude-chrome.md) · human renderings of workflows → [`v2-portal.md`](v2-portal.md)
